...
import { LEARN_CARDS } from './dataa/content';
import {
    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={s.navbar}>
        ...
        <View style={s.navCenter} pointerEvents="none">
          <Text style={s.navTitle}>Odd One Out — Learn</Text>
      ...
      <ScrollView ref={scrollRef} style={s.scroll} contentContainerStyle={s.scrollContent}
        ...
        {currentCard.example.sentences.map((sent, i) => (
          <View key={i} style={[s.exRow,
            sent.isOdd && { backgroundColor: '#FEF2F2', borderColor: '#EF4444', borderWidth: sc(2) }]}>
            <View style={[s.exLetter, { backgroundColor: sent.isOdd ? '#EF4444' : currentCard.accentColor }]}>
              <Text style={s.exLetterText}>{String.fromCharCode(65 + i)}</Text>
            </View>
            <View style={{ flex: 1 }}>
        ...
        <View style={s.learnNavRow}>
          ...
          {!isLastCard ? (
            ...
            <TouchableOpacity style={[s.learnNavFill, { backgroundColor: C.correct }]}
              onPress={() => navigation.navigate('OddOneOutPractice')}>
